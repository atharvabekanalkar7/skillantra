        ...
        <>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in text-left">
                    <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl scale-100 animate-fade-in-up">
                        <div className="p-6">
                            ...
                            <textarea
                                ...
                                className="w-full bg-slate-800 border-2 border-slate-700 rounded-xl p-4 text-white placeholder-white/30 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/20 transition-all resize-y min-h-[150px] mb-6"
                            ...
                            <div className="flex justify-end gap-3 font-semibold">
                                ...
                                <button
                                    ...
                                    disabled={submittingRequest}
                                    className="px-5 py-2.5 bg-indigo-600 text-white rounded-xl hover:bg-indigo-500 transition-all flex items-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {submittingRequest ? (
                                        <>
