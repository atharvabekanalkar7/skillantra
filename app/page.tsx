...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 via-blue-950 to-indigo-950 font-sans antialiased">
      ...
      <section className="relative min-h-screen overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-32">
          <div className={`flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center text-center ${mounted ? "animate-fade-in-up" : "opacity-0"}`}>
            <div className="flex flex-col items-center gap-8">
              ...
              {/* Main Headline */}
              <h2 className="max-w-5xl text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
              ...
              <p className="max-w-2xl text-lg leading-8 text-white/90 sm:text-xl md:text-2xl">
            ...
            <div className="mt-14 flex flex-col items-center gap-5 sm:flex-row sm:justify-center">
              ...
              <Link
                href="/login"
                className="flex h-14 min-w-[160px] items-center justify-center rounded-xl border-2 border-white/30 bg-white/5 px-10 font-semibold text-white backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:border-white/50 sm:w-auto"
              >
                Explore Projects
              </Link>
            </div>
      ...
      <section className="relative bg-gradient-to-b from-slate-950 via-indigo-950 via-purple-950 to-slate-950 py-32">
        <div className="absolute inset-0">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <div className="mb-24 text-center">
            <h2 className="text-5xl font-bold sm:text-6xl md:text-7xl mb-4">
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-32">
            {/* Card 1 */}
            <div className="group relative rounded-3xl border border-slate-700/50 bg-slate-900/30 backdrop-blur-xl p-10 transition-all duration-500 hover:border-blue-500/50 hover:bg-slate-900/50 hover:shadow-2xl hover:shadow-blue-500/10">
            ...
            {/* Card 2 */}
            <div className="group relative rounded-3xl border border-slate-700/50 bg-slate-900/30 backdrop-blur-xl p-10 transition-all duration-500 hover:border-indigo-500/50 hover:bg-slate-900/50 hover:shadow-2xl hover:shadow-indigo-500/10">
              <div className="mb-6 text-5xl">🤝</div>
            ...
            {/* Card 3 */}
            <div className="group relative rounded-3xl border border-slate-700/50 bg-slate-900/30 backdrop-blur-xl p-10 transition-all duration-500 hover:border-purple-500/50 hover:bg-slate-900/50 hover:shadow-2xl hover:shadow-purple-500/10">
              <div className="mb-6 text-5xl">⚡</div>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="rounded-3xl border border-slate-700/50 bg-slate-900/30 backdrop-blur-xl p-10 transition-all duration-500 hover:border-indigo-500/50 hover:bg-slate-900/50 hover:shadow-2xl hover:shadow-indigo-500/10">
              <div className="mb-6 text-5xl">🏫</div>
            ...
            <div className="rounded-3xl border border-slate-700/50 bg-slate-900/30 backdrop-blur-xl p-10 transition-all duration-500 hover:border-purple-500/50 hover:bg-slate-900/50 hover:shadow-2xl hover:shadow-purple-500/10">
              <div className="mb-6 text-5xl">🤝</div>
